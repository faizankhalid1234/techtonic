    ...
    >
      ...
      >
        ...
        <div className="flex min-w-0 shrink-0 items-center gap-1.5 sm:gap-2 md:gap-3">
          ...
          <span
            className="hidden rounded-lg border border-amber-500/35 bg-amber-500/10 px-2.5 py-1 text-[10px] font-semibold text-amber-200/95 xl:inline"
            title="Pay when your order is delivered"
          >
            Cash on delivery
          </span>
