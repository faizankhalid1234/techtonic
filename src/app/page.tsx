  ...
  return (
    <div className="flex flex-1 flex-col">
      <section className="hero-section relative min-h-[72svh] overflow-hidden bg-black md:min-h-[86svh]">
        <div className="pointer-events-none absolute -left-24 top-20 z-[2] hidden h-72 w-72 rounded-full bg-amber-500/15 blur-3xl md:block" />
        <div className="pointer-events-none absolute -right-24 top-40 z-[2] hidden h-80 w-80 rounded-full bg-fuchsia-500/10 blur-3xl md:block" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[72svh] w-full max-w-7xl flex-col px-4 pb-12 pt-4 md:min-h-[86svh] md:pb-16 md:pt-5">
          <div className="flex flex-1 flex-col justify-center pt-2 md:pt-4">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-zinc-950/85 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.45)] ring-1 ring-amber-500/15 backdrop-blur-none sm:p-8 md:bg-zinc-950/50 md:p-10 md:backdrop-blur-md">
              <div
                className="pointer-events-none absolute -right-8 -top-8 hidden h-40 w-40 rounded-full bg-amber-500/12 blur-3xl md:block"
                aria-hidden
              />
              <div
                className="pointer-events-none absolute -bottom-10 -left-10 hidden h-36 w-36 rounded-full bg-fuchsia-500/10 blur-3xl md:block"
                aria-hidden
              />
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Link
                href="/checkout"
                className="inline-flex w-full items-center justify-center rounded-xl border border-white/20 bg-zinc-950/70 px-5 py-2.5 text-sm font-medium text-zinc-100 transition hover:border-white/35 sm:w-auto md:bg-zinc-950/50 md:backdrop-blur-sm"
              >
                Checkout
              </Link>
            </div>
            <div className="mt-7 grid w-full max-w-md grid-cols-3 gap-2 text-center sm:gap-3">
              {[
                ...
                <div
                  key={s.label}
                  className="rounded-xl border border-white/10 bg-zinc-950/80 p-2.5 sm:bg-zinc-950/55 sm:p-3 md:backdrop-blur-md"
                >
        ...
        <div className="mx-auto w-full max-w-7xl px-4">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
            <div className="featured-card relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-b from-zinc-100 to-zinc-300 shadow-2xl shadow-black/30">
              ...
              <div className="pointer-events-none absolute bottom-4 left-1/2 hidden h-8 w-3/4 -translate-x-1/2 rounded-full bg-black/25 blur-2xl md:block" />
              <div className="featured-shine" aria-hidden />
              <Image
                src="/featured-picks-v3.png"
                alt="Tech Tonic featured picks product image"
                width={1148}
                height={1536}
                unoptimized
              ...
              <div className="absolute inset-x-0 bottom-0 z-20 p-3 sm:p-4">
                <div className="rounded-2xl border border-zinc-700/70 bg-zinc-950/92 p-3 sm:bg-zinc-950/80 sm:p-4 md:backdrop-blur-sm">
